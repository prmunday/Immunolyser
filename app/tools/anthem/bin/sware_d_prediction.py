...
def pred(features, length, fastafile = None, thresholdvalueadjust = None,res='res'):
    ...
    # with open('%s/app/tools/anthem/source/20200511_dict_lenHLAnumselect.json' % currentpath, 'r') as f:
        fstr = f.read()
