...
def checkarg(args):
    ...
    if args.peptide_file:
        ...
        if args.threshold:
            ...
            return([HLAlist, namepeptides, peptidelength, None, thresholdvalueadjust,str(args.o)])
        else:
            return([HLAlist, namepeptides, peptidelength, None, None,str(args.o)])
        ...
        if args.threshold:
            thresholdvalueadjust = int(args.threshold)/100
            return([HLAlist, namepeptides, None, fastafile, thresholdvalueadjust,str(args.o)])
        else:
            return([HLAlist, namepeptides, None, fastafile, None,str(args.o)])